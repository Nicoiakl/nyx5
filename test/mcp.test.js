...
test('D1 · hay 25 herramientas y ninguna description quedó como la vieja documentación de API', () => {
  assert.equal(tools.length, 25, `se esperaban 25 herramientas, hay ${tools.length}`);
