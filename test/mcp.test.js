...
test('D1 · hay 26 herramientas y ninguna description quedó como la vieja documentación de API', () => {
  assert.equal(tools.length, 26, `se esperaban 26 herramientas, hay ${tools.length}`);
