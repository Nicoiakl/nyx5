...
test('D1 · hay 24 herramientas y ninguna description quedó como la vieja documentación de API', () => {
  assert.equal(tools.length, 24, `se esperaban 24 herramientas, hay ${tools.length}`);
