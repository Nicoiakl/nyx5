...
test/                    correo · libro · registro · invariantes+D1 · indice · concurrencia · altos ·
                         ...
                         puertos (guard de colisión) · x402 · interop · custodia · puente-remoto · asistente · app-recibos · grupos · lectura · perfil · tasa · visibilidad · estado -> `npm test` (259)
...
```
npm test                 # 259 pruebas, todas deben pasar antes de cualquier commit
