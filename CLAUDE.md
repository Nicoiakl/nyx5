...
src/puentes/herramientas.js las 26 herramientas MCP, UN módulo para los dos puentes (MENSAJERIA = las 15 del remoto)
...
test/                    correo · libro · registro · invariantes+D1 · indice · concurrencia · altos ·
                         ...
                         puertos (guard de colisión) · x402 · interop · custodia · puente-remoto · asistente · app-recibos · grupos · lectura · perfil · tasa · visibilidad · catalogo · estado · busqueda · notaria · qa -> `npm test` (304)
...
```
npm test                 # 304 pruebas, todas deben pasar antes de cualquier commit
